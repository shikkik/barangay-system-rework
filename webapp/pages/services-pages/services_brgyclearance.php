...
<html>
  <head> 
    ...
    <body>
        ...
        <div class="container-fluid container1"> 
            <div class="row"> 
                <div class="col"> 
                    ...
                    <img class="picture" src="../../image-assets/services-icons/docu1.png">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img class="picture" src="../../image-assets/services-icons/docu2.png">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img class="picture" src="../../image-assets/services-icons/docu3.png">
                </div>
            </div>
        </div>
        ...
        <script src="../libraries-frameworks/bootstrap-5.0.2/js/bootstrap.bundle.js" type="text/javascript" crossorigin="anonymous"> </script>
